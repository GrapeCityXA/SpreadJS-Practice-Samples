...
function initSpread(spread) {
    ...
    var company1 = new Company("Baidu", null, "We know everything!", "Beijing 1st road", "Beijing", "010-12345678", "baidu@baidu.com"),
        ...
        records1 = [new Record("Finance charge on overdue balance at 1.5%", 0, 150), new Record("Invoice #100 for $1000 on 2014/1/1", 1, 150)],
    ...
    //     })
    // tableColumn2.formatter('[=1]定性指标;[=0]定量指标');
    ...
    document.getElementById("getDataSource").addEventListener('click', function () {
        var sheet = spread.getActiveSheet();
