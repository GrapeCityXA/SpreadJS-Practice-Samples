...
var template = {
    ...
    三级项目: {
      ...
      theme: {
        ...
        themeColor: {
          ...
          background2: { a: 255, r: 238, g: 236, b: 225 },
          text1: { a: 255, r: 0, g: 0, b: 0 },
          text2: { a: 255, r: 31, g: 73, b: 125 },
          accent1: { a: 255, r: 79, g: 129, b: 189 },
          accent2: { a: 255, r: 192, g: 80, b: 77 },
          accent3: { a: 255, r: 155, g: 187, b: 89 },
          accent4: { a: 255, r: 128, g: 100, b: 162 },
          accent5: { a: 255, r: 75, g: 172, b: 198 },
          accent6: { a: 255, r: 247, g: 150, b: 70 },
          hyperlink: { a: 255, r: 0, g: 0, b: 255 },
          followedHyperlink: { a: 255, r: 128, g: 0, b: 128 },
        },
        headingFont: "Cambria",
        bodyFont: "Calibri",
      },
      data: {
        dataTable: {
          0: {
            0: {
              value: "三级项目项目公司“千分制”制度落实评价打分汇总表",
              style: "__builtInStyle31",
            },
            1: { style: "__builtInStyle31" },
            2: { style: "__builtInStyle31" },
            3: { style: "__builtInStyle31" },
            4: { style: "__builtInStyle31" },
            5: { style: "__builtInStyle31" },
            6: { style: "__builtInStyle31" },
          },
          1: {
            0: { value: "序号", style: "__builtInStyle25" },
            1: { value: "类型", style: "__builtInStyle25" },
            2: { value: "部门", style: "__builtInStyle25" },
            3: { value: "因子系数", style: "__builtInStyle27" },
            4: { value: "权重", style: "__builtInStyle27" },
            5: { value: "公司名称", style: { parentName: "__builtInStyle32" } },
            6: { style: "__builtInStyle32" },
          },
          2: {
            0: { style: "__builtInStyle26" },
            1: { style: "__builtInStyle26" },
            2: { style: "__builtInStyle26" },
            3: { style: "__builtInStyle28" },
            4: { style: "__builtInStyle28" },
            5: { value: "评价分", style: "__builtInStyle13" },
            6: { value: "权重得分", style: "__builtInStyle3" },
          },
          5: {
            0: { value: "合计", style: { hAlign: 1 } },
            3: { value: 0, formula: "SUBTOTAL(109,Table1[yinzi])" },
            4: { value: 0, formula: "SUBTOTAL(109,Table1[quanzhong])" },
            5: { value: 0, formula: "SUBTOTAL(109,Table1[Column5])" },
            6: { value: 0, formula: "SUBTOTAL(109,Table1[Column6])" },
          },
        },
        columnDataArray: [
          null,
      ...
      topCellIndex: 0,
      spans: [
        { row: 1, rowCount: 1, col: 5, colCount: 2 },
        { row: 1, rowCount: 2, col: 0, colCount: 1 },
        { row: 1, rowCount: 2, col: 1, colCount: 1 },
        { row: 1, rowCount: 2, col: 2, colCount: 1 },
        { row: 1, rowCount: 2, col: 3, colCount: 1 },
        { row: 1, rowCount: 2, col: 4, colCount: 1 },
        { row: 0, rowCount: 1, col: 0, colCount: 7 },
        { row: 5, rowCount: 1, col: 0, colCount: 2 },
      ],
      selections: {
        0: { row: 6, rowCount: 1, col: 7, colCount: 1 },
        length: 1,
      },
      defaults: {
      ...
      tables: [
        {
          ...
          style: {
            name: "表样式 1",
            wholeTableStyle: {
              borderLeft: { color: "Text 1", style: 1 },
              borderTop: { color: "Text 1", style: 1 },
              borderRight: { color: "Text 1", style: 1 },
              borderBottom: { color: "Text 1", style: 1 },
              borderHorizontal: { color: "Text 1", style: 1 },
              borderVertical: { color: "Text 1", style: 1 },
            },
          },
          autoGenerateColumns: false,
          bindingPath: "table",
          rowFilter: {
            range: { row: 3, rowCount: 2, col: 0, colCount: 7 },
          ...
          columns: [
            { name: "xuhao", dataField: "xuhao", footerValue: "合计" },
            { id: 1, name: "leixing", dataField: "leixing" },
            { id: 2, name: "bumen", dataField: "bumen" },
            {
              id: 3,
              name: "yinzi",
              dataField: "yinzi",
              footerFormula: "SUBTOTAL(109,Table1[yinzi])",
            },
            {
              id: 4,
              name: "quanzhong",
              dataField: "quanzhong",
              footerFormula: "SUBTOTAL(109,Table1[quanzhong])",
            },
            {
              id: 5,
              name: "Column5",
              footerFormula: "SUBTOTAL(109,Table1[Column5])",
            },
            {
              id: 6,
              name: "Column6",
              footerFormula: "SUBTOTAL(109,Table1[Column6])",
            },
          ],
        },
      ],
  ...
  namedStyles: [
    ...
    },
    {
      ...
      hAlign: 1,
      vAlign: 1,
      font: "normal normal 18.7px Calibri",
      themeFont: "Body",
      borderLeft: null,
      borderTop: null,
      borderRight: null,
    ...
    properties: {
      table: {
        ...
        items: {
          type: "object",
          properties: {
            xuhao: { dataFieldType: "text", type: "string" },
            leixing: { type: "string" },
            bumen: { type: "string" },
            yinzi: { type: "string" },
            quanzhong: { type: "string" },
          },
        },
      },
      "field-1": { dataFieldType: "text", type: "string" },
      "field-2": { dataFieldType: "text", type: "string" },
      "field-3": { dataFieldType: "text", type: "string" },
    },
    type: "object",
  },
};
...
$("#bind_btn").click(function () {
  ...
  data.table.forEach(function (item) {
    for (let i = 0; i < item.gongsi.length; i++) {
      item["gongsi_" + item.gongsi[i].name + "_pingjia"] =
        item.gongsi[i].pingjia;
