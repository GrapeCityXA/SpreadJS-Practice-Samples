...
sheet.setValue(0, 1, 'grapecity')
sheet.setValue(0, 2, 'grapecity')
sheet.setValue(1, 0, 'grapecity')
sheet.setValue(1, 1, 'grapecity')
sheet.setValue(1, 2, 'grapecity')
sheet.setValue(2, 0, 'grapecity')
sheet.setValue(2, 1, 'grapecity')
...
function getScreenshotBlbo(spread) {
    return new Promise(function (resolve, reject) {
        ...
        console.profile("printInfo")
        sheet.printInfo(printInfo)
        console.profileEnd("printInfo")
        ...
        spread.bind(GC.Spread.Sheets.Events.BeforePrint + ".screenshot", (s, e) => {
            ...
            if (imgs && imgs.length) {
                ...
                console.time("oldPrintInfo")
                sheet.printInfo(oldPrintInfo)
                console.timeEnd("oldPrintInfo")
            }
        })
