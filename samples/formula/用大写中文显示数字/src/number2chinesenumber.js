...
// 代码来自 改动了10的显示方式
// https://github.com/wansongtao/chinese-number
 ...
 */
let modeType = 'default' | 'amount' | 'max' | 'maxAmount';
const chineseDigits = [
  '零',
  '一',
  '二',
...
export const ltTenThousand = (digit, mode = 'default') => {
  if (digit > 9999) {
    return '';
  }
