...
let selectList = [{ name: 'MUL1', value: 0 }, { name: 'MUL2', value: 1 }, { name: 'MUL3', value: 2 }];
...
DropdownMultiSelect.prototype.setEditorValue = function (editor, value, context) {
    $(editor).val(value)
};
...
DropdownMultiSelect.prototype.updateEditor = function (editorContext, cellStyle, cellRect) {
    if (editorContext) {
        let $editor = $(editorContext); $editor.css('width', cellRect.width); return { height: 300 };
    }
};
