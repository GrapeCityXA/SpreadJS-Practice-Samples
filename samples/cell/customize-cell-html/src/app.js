...
sheet.getCell(1, 1).cellType(new HTMLCellType()).value('<h1 style="text-decoration: line-through;">Hello SpreadJS!</h1><h3>E=mc<sup>2</sup></h3><h2><em style="color:red">I</em> like ' +
    ...
    'Javascript</span></h2><p>aaaa</p><img style="width:100px;height:100px;display:none;" src="https://img-s-msn-com.akamaized.net/tenant/amp/entityid/AA17SbZ4.img?w=612&h=304&q=90&m=6&f=jpg&u=t"/><p>aaaa</p>').wordWrap(true);
